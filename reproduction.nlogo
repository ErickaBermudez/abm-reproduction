...
to setup-globals
  ...
  set avg_annual_income avg-annual-income
...
to check-reproduce
  ...
  let partner-age [ age ] of partner

  ;; if they have enough money
  ifelse annual_earnings + partner-earnings > (cost_of_child * (children + 1)) + cost_of_living [
...
to try-new-turtle
  ...
  if age < 51 [ set conceiving-rate .10 ]
